      ...
      {featuredPost && (
        ...
        >
          <Link href={`/blog/${featuredPost.slug}`}>
            <div className="group bg-white/5 backdrop-blur-sm border border-gray-700/50 rounded-3xl overflow-hidden hover:bg-white/10 hover:border-gray-600 transition-all duration-700">
                ...
                <div className="relative overflow-hidden aspect-[4/3] lg:aspect-auto">
                  ...
                  {!featuredPost.featuredImage && (
                    <div className="w-full h-full bg-gradient-to-br from-blue-500/20 to-purple-600/20 flex items-center justify-center">
                      <div className="text-white/60 text-lg">No image</div>
                    </div>
                  )}
                </div>
